...
/*=============== SWIPER POPULAR ===============*/
let swiperFavorite = new Swiper(".popular__content", {
  slidesPerView: "auto",
  centeredSlides: true,
  loop: true,
  // grabCursor: "true",
...
faqItems.forEach((el) => {
  el.addEventListener("click", () => {
    let heightElement = el.querySelector(".choose__faq-content");
    if (el.classList.contains("faq-open")) {
      el.classList.remove("faq-open");
      heightElement.removeAttribute("style");
    } else {
      faqItems.forEach((l) => {
        l.classList.remove("faq-open");
        let heightElement = l.querySelector(".choose__faq-content");
        heightElement.removeAttribute("style");
      });
      el.classList.add("faq-open");
      console.log(heightElement);
      heightElement.style = `
        height: ${heightElement.scrollHeight}px`;
    }
  });
});
